...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__validators_email__ = __webpack_require__(483);
...
var LoginPage = (function () {
    function LoginPage(navCtrl, authData, formBuilder, alertCtrl, loadingCtrl, storage) {
    ...
    LoginPage.prototype.loginUser = function () {
        ...
        if (!this.loginForm.valid) {
            ...
            this.authData.loginUser(this.loginForm.value.email, this.loginForm.value.password)
                ...
                var usr = _this.loginForm.value.email.split('@');
                //this.storage.set('user', usr[0]);
                _this.storage.set("user", JSON.stringify(usr[0]));
                _this.storage.set("mail", JSON.stringify(usr[1]));
                _this.navCtrl.push('RoomPage');
            }, function (error) {
